...
namespace Yaar.Tickers
{
    class TwitterTicker : TickerBase
    {
        ...
        public TwitterTicker() : base(1.Minutes())
        {
        }
        ...
        protected override void Tick()
        {
            ...
            foreach (var tweet in tweets.Results.Where(o => o.Time > last))
            {
                if (tweet.Entities.Urls.Any())
                {
                    ...
                    ToastView.Create(tweet.Text, tweet.From_user_name, tweet.Entities.Urls.First().Url, false);
                }
                else
                    ToastView.Create(tweet.Text, tweet.From_user_name, false);
